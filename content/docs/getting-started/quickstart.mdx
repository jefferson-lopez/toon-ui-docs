...
If you want to inspect the full prompt later, see [Full Generated Prompt](/docs/reference/full-generated-prompt).
...
1. [Configuration](/docs/getting-started/configuration)
