...
| Layer | Owns what |
|---|---|
| `toon.prompt` | Canonical ToonUI language contract |
| App-specific instructions | Your domain behavior and assistant framing |
| Tool list / tool policy | What your host app can actually do |
...
For the advanced reference, see [Full Generated Prompt](/docs/reference/full-generated-prompt).
...
For the advanced prompt reference, see [Full Generated Prompt](/docs/reference/full-generated-prompt).
