...
Here, `toon.prompt` is the canonical ToonUI contract.
Your app-specific instructions still belong AFTER it.
...
4. [Full Generated Prompt](/docs/reference/full-generated-prompt)
